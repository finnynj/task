...
class _HomePageState extends State<HomePage> {
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  GestureDetector(
                                                    child: Text(_birthday == null || _birthday.isEmpty ? "Date of Birth" : _birthday,
                                                      style: TextStyle(
                                                        color: Colors.white,
                                                      ),
                                                    ),
                                                  ...
                                                  Divider(
                                                    thickness: 1,
                                                    color: !_validBirthday ? Colors.red : Colors.white,
                                                  ),
                                                  !_validBirthday ? Text("Date of Birth Required", style: TextStyle(fontSize: 12, color: Colors.red),) : Container(),
                                                ],
                                              ),
                                            ),
                                            SizedBox(
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Divider(
                                                    thickness: 1,
                                                    color: !_validGender ? Colors.red : Colors.white,
                                                  ),
                                                  !_validGender ? Text("Gender Required", style: TextStyle(fontSize: 12, color: Colors.red),) : Container(),
                                                ],
                                              ),
                                            ),
                                          ],
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Divider(
                                              thickness: 1,
                                              color: !_validBloodGroup ? Colors.red : Colors.white,
                                            ),
                                            !_validBloodGroup ? Text("Gender Required", style: TextStyle(fontSize: 12, color: Colors.red),) : Container(),
                                          ],
                                        ),
                                        ),
                                      SizedBox( height: 30 ),
                                ...
                                Container(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      _selectedAllergies == null || _selectedAllergies.isEmpty? Container() : Wrap(
                                        spacing: 6.0,
                                        runSpacing: 6.0,
                                        children: List<Widget>.generate(_selectedAllergies.length, (int index)
                                        {
                                          return Chip(
                                            label: Text(
                                            ...
                                            deleteIcon: Icon(Icons.remove_circle_outline_sharp, color: Colors.white,),
                                            onDeleted: () {
                                              setState(() {
                                                _selectedAllergies.remove(_selectedAllergies[index]);
                                      ...
                                      _selectedAllergies == null || _selectedAllergies.isEmpty ? Container() : Divider(
                                        thickness: 1,
                                        color: Colors.white,
                                      ),
                                    ],
                                ...
                                Container(
                                  ...
                                  child: TextButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      setState(() {
                                        _selectedBloodGroup == null || _selectedBloodGroup.isEmpty ? _validBloodGroup = false : _validBloodGroup = true;
                                        _selectedGender == null || _selectedGender.isEmpty ? _validGender = false : _validGender = true;
                                        _birthday == null || _birthday.isEmpty ? _validBirthday = false : _validBirthday = true;
                                      });
                                      submitForm();
                                    },
                                    child: Text(
  ...
  void submitForm() {
    ...
    CollectionReference collectionReference =  Firestore.instance.collection("Patient Info");
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => ProfileCreated( userName: userName,)),
    );
